        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12 animate-on-scroll">
            <a 
              ...
              className="group p-8 bg-text/[0.03] hover:bg-teal/5 rounded-2xl transition-all text-left"
            >
              ...
              <div className="text-sm font-medium text-teal mb-1">Email</div>
            ...
            >
              ...
              <div className="text-sm font-medium text-teal mb-1">LinkedIn</div>
